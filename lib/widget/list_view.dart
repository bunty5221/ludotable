...
import '../UI Screens/contest_details.dart';
import '../constants.dart';

class ListContest extends StatefulWidget {
  const ListContest({Key? key}) : super(key: key);

  @override
  State<ListContest> createState() => _ListContestState();
}

class _ListContestState extends State<ListContest> {
  double percent = 0;
  String txt="Join";
  int joinplayer= 2;
  int playercount= 0;
